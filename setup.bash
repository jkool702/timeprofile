...

{
    ...
    trap 'echo ": ${BASH_COMMAND}" >&${pTime[1]} || :' DEBUG

    # set exit trap to clear debug trap. If another exit trap already exists add this into it.
    trap 'trap - DEBUG; echo "The generated line-by-line time profile is located at '"${timeProfileFile}"'" >&2' EXIT TERM HUP QUIT
